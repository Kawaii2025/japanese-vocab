...
console.log('🔍 [Management] VITE_USE_STREAMING_AI env:', import.meta.env.VITE_USE_STREAMING_AI);
const USE_STREAMING_AI = import.meta.env.VITE_USE_STREAMING_AI === 'true';
console.log('🔍 [Management] USE_STREAMING_AI computed:', USE_STREAMING_AI);
